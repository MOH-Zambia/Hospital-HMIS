...
from HospitalHMIS.utils import env, IS_WIN, fs_short_path
...
APP_NAME = 'Hospital HMIS'
APP_ICON = 'HospitalHMIS-icon'
...
APP_COPYRIGHT = 'Copyright (C) 2020, GRZ - Ministry of Health'
...
if IS_WIN:
    ...
    if SERVER_MODE:
        DATA_DIR = '/var/lib/HospitalHMIS'
    else:
        DATA_DIR = os.path.realpath(os.path.expanduser(u'~/.HospitalHMIS/'))
...
if SERVER_MODE and not IS_WIN:
    LOG_FILE = '/var/log/HospitalHMIS/HospitalHMIS.log'
else:
    LOG_FILE = os.path.join(DATA_DIR, 'HospitalHMIS.log')
...
SQLITE_PATH = env('SQLITE_PATH') or os.path.join(DATA_DIR, 'HospitalHMIS.db')
...
#
# SESSION_DB_PATH (Default: $HOME/.HospitalHMIS/sessions)
##########################################################################
#
...
#
# SESSION_DB_PATH = '/run/shm/HospitalHMIS_session'
#
##########################################################################
SESSION_DB_PATH = os.path.join(DATA_DIR, 'sessions')

SESSION_COOKIE_NAME = 'HospitalHMIS_session'
...
UPGRADE_CHECK_URL = 'https://www.moh.gov.zm.org/hopital/versions.json'

# What key should we look at in the upgrade data file?
UPGRADE_CHECK_KEY = 'HospitalHMIS'
...
TEST_SQLITE_PATH = os.path.join(DATA_DIR, 'test_HospitalHMIS.db')
